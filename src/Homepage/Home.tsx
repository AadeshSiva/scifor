      ...
      <main>
        ...
        <section className="w-full relative bg-white pt-14 pb-0 px-20 max-md:pt-10 max-md:pb-0 max-md:px-8 max-sm:pt-8 max-sm:pb-0 max-sm:px-5">
          ...
          <div className="text-[#D02C31] text-center text-[28px] font-bold max-w-[982px] mb-6 mx-auto max-md:text-2xl max-md:mb-5 max-sm:text-xl max-sm:mb-4">
            ...
            <span>
              {" "}
              only got fair market value when sold, most entrepreneurs, no
              matter how successful, LOSE on exit.
            </span>
          </div>
          <p className="text-black text-center text-[28px] font-medium max-w-[1238px] mb-6 mx-auto max-md:text-2xl max-md:mb-5 max-sm:text-xl max-sm:mb-4">
            Like you, they didn't start and grow a business to LOSE – but LOSE
            they did.​ What did they do wrong? They didn't grow value where 84%
            of their business value exists – intangibles.
          </p>
          ...
          <p className="text-black text-center text-[28px] font-medium leading-9 max-w-[760px] mb-10 mx-auto max-md:text-2xl max-md:mb-8 max-sm:text-xl max-sm:mb-6">
            You Grow Smart by building a marketable company: maximizing,
            monetizable value (via intangibles), tax effectively, ​ using a
            UPhTM (Unifying Philosophy) asset.
          </p>
            ...
            <div className="flex flex-col gap-3 items-center mb-4">
              {[
                ...
                <div key={index} className="flex items-center gap-3">
                  ...
                  <div className="text-[#2B2B2B] text-[10px] tracking-normal">
                    {item}
                  </div>
                </div>
              ))}
        ...
        <section className="w-full relative bg-[#F4F4F4] px-0 py-20">
          <div className="text-center mb-20">
            ...
            <p className="text-[#555] text-center text-[28px] font-normal leading-8 max-w-[589px] mx-auto my-0 max-sm:text-xl">
              Jeff grew and exited his freight services company ​ with double
              digit multiples, all tax effectively
            </p>
          </div>
          ...
          <div className="text-center mb-20">
            ...
            <div className="max-w-[570px] mt-0 mb-20 mx-auto max-md:max-w-full max-md:px-8 max-md:py-0">
              ...
              <p className="text-black text-center text-[28px] font-bold leading-8 mb-6 max-md:text-2xl max-sm:text-xl">
                By creating and operationalizing ​ "Prosperity For All" - ​ his
                (Unifying Philosophy) UPhTM​
              </p>
              <p className="text-black text-justify text-[28px] font-bold leading-8 mb-6 max-md:text-2xl max-sm:text-xl">
            ...
            <div className="max-w-[870px] flex flex-col gap-10 mx-auto my-0 max-md:px-8 max-md:py-0 max-sm:px-5 max-sm:py-0">
              <p className="text-black text-justify text-xl font-normal leading-8 max-md:text-lg max-md:leading-7 max-sm:text-base max-sm:leading-6">
                Jeff Cullen, a Canadian entrepreneur and logistics executive is
                best known as the founder and former CEO of Rodair, a
                Toronto-based third-party logistics provider.
              </p>
              <p className="text-black text-justify text-xl font-normal leading-8 max-md:text-lg max-md:leading-7 max-sm:text-base max-sm:leading-6">
                He launched Rodair in 1996 with just three employees, and by
                2012, the company had expanded to 27 offices across 17
                countries, generating CAD 170 million in sales.
              </p>
              <p className="text-black text-justify text-xl font-normal leading-8 max-md:text-lg max-md:leading-7 max-sm:text-base max-sm:leading-6">
                Under his leadership, Rodair became a full-service supply chain
                provider with 155 employees across Canada, serving industries
                such as fashion, retail, automotive, and mining.
              </p>
              <p className="text-black text-justify text-xl font-normal leading-8 max-md:text-lg max-md:leading-7 max-sm:text-base max-sm:leading-6">
                In 2019, Rodair was acquired by Rhenus Logistics, a German
                global logistics firm. Cullen continued to lead the Canadian
                operations under the new name, Rhenus Canada. He emphasized a
                unifying business philosophy centered on shared prosperity,
                transparency, and long-term sustainability. His leadership style
                focused on creating value for all stakeholders—clients,

  ...
  return (
    <section className="flex flex-col items-center text-center py-12 pb-0 relative">
      ...
      <p className="text-[#818181] text-center text-[28px] font-medium leading-9 max-w-[1200px] mb-3 mx-auto max-md:text-2xl max-md:mb-8 max-sm:text-xl max-sm:mb-6 flex-col">
        <p className="text-lg">
          TORONTO: March 18, 2019. The Rhenus Group has acquired Canadian
          logistics company Rodair International subject to
        </p>
        <p className="mb-3 text-lg">
          regulatory approval. Terms of the sale were not disclosed.
        </p>
      </p>
      ...
      <div className="bg-white w-screen py-12 ">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="text-teal-600 text-2xl mb-6 ">
            <span className="font-semibold">He built a valuable company.</span>{" "}
            ​<br />
            He made it valuable for the buyer - from day one.​
            <br />
          ...
          <div className="text-2xl leading-8 mb-8">
            ...
            <p className="mb-2">
              ...
              <span className="font-bold">
                , the DNA of his business (in 6 words or less)​​
              </span>
            </p>
            <p className="text-teal-600 mb-2">
          ...
          <p className="text-black text-3xl font-semibold">
            That’s how we help you win too.{" "}
          </p>
        </div>
      </div>
      {/* Steps display */}
            ...
            <div key={step.id} className="flex flex-col gap-4">
              ...
              <div className="aspect-video rounded-lg overflow-hidden">
                <iframe
                  ...
                  src="https://imagekit.io/player/embed/je0rl3nnt/63Qa3wVBkJ-MVK80k4KdY-240p.mp4/ik-video.mp4?updatedAt=1748406580407&thumbnail=https%3A%2F%2Fik.imagekit.io%2Fje0rl3nnt%2F63Qa3wVBkJ-MVK80k4KdY-240p.mp4%2Fik-video.mp4%2Fik-thumbnail.jpg%3FupdatedAt%3D1748406580407&updatedAt=1748406580407"
    ...
    <section className="bg-white w-full overflow-hidden">
      <div className="max-w-3xl mx-auto text-center px-4">
        ...
        <p className="text-[#A71F23] font-semibold mb-8 text-2xl">
          ...
          equal or exceed everything you sacrificed for ​<br /> all those years
      ...
      <div className="flex justify-center mb-20">
        <button className="bg-black text-white text-lg font-medium py-4 px-16 rounded max-w-2xl w-full text-center hover:bg-gray-800 transition-colors">
          ...
          <span className="text-lg">
            (because I refuse to risk everything, I have worked all these years
            for)
          </span>
        </button>
      </div>

...
const LongAccordion: React.FC<LongAccordionProps> = ({ data = [], className = "" }) => {
  ...
  return (
    <div className={`w-full flex flex-col gap-7  ${className}`}>
      ...
      <div
        ref={navbarRef}
        className="sticky-fixed top-[86px] z-10 bg-[#F5F5F5] px-4 sm:px-6 lg:px-8 py-4 border border-gray-500 shadow-lg rounded-lg"
      >
                          ...
                          <div className="text-gray-600 text-sm sm:text-base leading-relaxed space-y-4">
                            {researchPoint.statistics.map((stat, statIndex) => (
                              ...
                              >
                                ...
                                {stat.url && (
                                  <div className="flex flex-col items-center gap-2 flex-shrink-0">
                                    <div className="w-16 h-12 sm:w-20 sm:h-16 bg-gray-600 rounded-lg flex items-center justify-center">
                                      <svg
                                        width="20"
                                        height="20"
                                      ...
                                      >
                                        <path
                                          d="M6 8h20v16H6V8zm2 2v12h16V10H8zm6 4h8v2h-8v-2zm0 4h6v2h-6v-2z"
                                          fill="white"
                                        />
                                      </svg>
                                    </div>
      ...
      {data.length === 0 && (
        <div className="max-w-6xl mx-auto p-8 text-center text-gray-500">
          <p className="text-lg mb-4">
            No data available. Connect to your backend API at <code>/category-list</code>
          </p>
          <p className="text-sm">Expected data structure:</p>
          <pre className="text-left bg-gray-100 p-4 rounded mt-4 text-xs overflow-auto">
            {`[

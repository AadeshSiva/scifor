...
const BrandDiagnostic: React.FC = () => {
  ...
  const questions: Question[] = [
    ...
    // Brand Wealth Management Section
    {
      id: "wealth_1",
  ...
  const handleSubmit = () => {
    ...
    alert("Brand Diagnostic submitted successfully!");
  };
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              className="flex items-center px-8 py-3 rounded bg-green-600 text-white hover:bg-green-700 font-semibold"
            >
              Submit Assessment

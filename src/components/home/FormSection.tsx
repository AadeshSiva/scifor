        ...
        <div className="bg-white rounded-xl border-2 border-gray-300 overflow-hidden w-full max-w-xl shadow-sm">
          <div className="aspect-video relative w-full">
            <iframe
              ...
              src="https://imagekit.io/player/embed/je0rl3nnt/63Qa3wVBkJ-r5QoRy7KVM-240p.mp4/ik-video.mp4?updatedAt=1748406554368&thumbnail=https%3A%2F%2Fik.imagekit.io%2Fje0rl3nnt%2F63Qa3wVBkJ-r5QoRy7KVM-240p.mp4%2Fik-video.mp4%2Fik-thumbnail.jpg%3FupdatedAt%3D1748406554368&updatedAt=1748406554368"
      ...
      <div className="flex justify-center items-start gap-8 -mb-20 mt-10">
        ...
        <div className="bg-white rounded-xl border-2 border-gray-300 p-6 w-full max-w-md shadow-sm">
          ...
          <div className="flex w-full justify-center">
            <div className="flex flex-col items-start space-y-2 mb-4 text-left font-linear ">
              {" "}
              <div className="text-gray-800 text-xs font-medium flex items-start gap-2">
                {" "}
                <Check size={16} strokeWidth={4} />{" "}
                <span className="font-light">Exited with Double-Digit Multiples</span>{" "}
              </div>{" "}
              <div className="text-gray-800 text-xs font-medium flex items-start gap-2">
                {" "}
                <Check size={16} strokeWidth={4} />{" "}
                <span className="font-light">Achieved 25%+ Profit Margins</span>{" "}
              </div>{" "}
              <div className="text-gray-800 text-xs font-medium flex items-start gap-2">
                {" "}
                <Check size={16} strokeWidth={4} />{" "}
                <span className="font-light">Tax Smart Generational Wealth</span>{" "}
              </div>{" "}
              <div className="text-gray-800 text-xs font-medium flex items-start gap-2">
                {" "}
                <Check size={16} strokeWidth={4} /> <span className="font-light">And more...</span>{" "}
              </div>{" "}
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onFormSubmit)} className="font-linear">
            <div className="mb-3">
              <label className="text-black text-xs font-medium block mb-1">Full Name</label>
              <input
                type="text"

            ...
            <header>
              <div className="flex h-11 items-center w-full box-border bg-neutral-100 pt-3 pb-[11px] px-6 max-sm:pt-3 max-sm:pb-[11px] max-sm:px-4">
                ...
                >
                  ...
                  >
                    <path
                      d="M8.85062 10.3274L15.3447 16.8215L14.1662 18L7.67212 11.506L1.17804 18L-0.000463486 16.8215L6.49362 10.3274L-0.000463486 3.83337L1.17804 2.65479L7.67212 9.14888L14.1662 2.65479L15.3447 3.83337L8.85062 10.3274Z"
                      fill="#555555"
                    />
                  </svg>
                  <span className="font-['Linear_Grotesk'] text-sm">
                    Create poll
                  </span>
                </button>
              </div>
            ...
            <main className="p-6 max-sm:p-4">
              ...
              <div className="mb-6">
                ...
                {formData.options.map((option) => (
                  <div
                    key={option.id}
                    className="flex items-center gap-4 h-6 mb-3"
                  >
                    <button type="button" className="text-[#555]">
                      ...
                      >
                        <path
                          d="M7.01294 13.2419C7.06334 12.4407 7.25521 11.6778 7.56387 10.9781C6.5405 10.8831 5.6121 10.4575 4.8884 9.80974L5.77761 8.81621C6.36779 9.34447 7.14554 9.66487 7.99967 9.66487C8.11721 9.66487 8.23307 9.65881 8.34707 9.64701C9.48434 8.14427 11.2437 7.13854 13.2419 7.01294C12.7791 4.53885 10.6081 2.66634 7.99967 2.66634C5.05415 2.66634 2.66634 5.05415 2.66634 7.99967C2.66634 10.6081 4.53885 12.7791 7.01294 13.2419Z"
                          fill="#555555"
                        />
                      </svg>
                    </button>
                    ...
                    <button type="button" className="text-[#555]">
                      ...
                      >
                        <path
                          d="M5.66699 4.66699C6.21928 4.66699 6.66699 4.21928 6.66699 3.66699C6.66699 3.11471 6.21928 2.66699 5.66699 2.66699C5.11471 2.66699 4.66699 3.11471 4.66699 3.66699C4.66699 4.21928 5.11471 4.66699 5.66699 4.66699Z"
                          fill="#555555"
                        />
                      </svg>
                    </button>

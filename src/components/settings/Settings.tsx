          ...
          <div className="flex flex-col mt-16 w-full min-h-screen justify-center items-center overflow-hidden">
            <div className="flex flex-col w-1/2 h-[80vh] justify-left items-left p-4 gap-8">
              ...
              <div className="flex flex-col h-[60vh] w-[50vw]">
                <button
                  className="flex justify-between border border-gray-500 p-6 rounded-t-lg bg-gray-200"
                  onClick={handleProfleView}
                >
                ...
                <button
                  className="flex justify-between border border-gray-500 p-6 bg-gray-200"
                  onClick={handleUsernameView}
                >
                  <span>Change Username</span>
                  <span>
                    {user.username} <span className="ml-4">{">"}</span>
                  </span>
                </button>
                <button
                  className="flex justify-between border border-gray-500 p-6 bg-gray-200"
                ...
                <button
                  className="flex justify-between border border-gray-500 p-6 rounded-b-lg bg-gray-200 w-full"

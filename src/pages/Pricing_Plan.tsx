...
const Pricing_Plan: React.FC = () => {
  ...
  const messages1: { [key: string]: string | string[] } = {
    ...
    "CRITICAL TOOLS": "List all the tools to be made available – in Oct/Nov - for now here is a list of key problems by dept or function check all the areas in which you have struggles in",
    "CURATED": "",
    "CURES (Done–for–You Tools)": "",
    "COACHING (Winning skills – course relevant)": "Tell us what area of coaching you need – replays only  ",
    "CLOUT": [
    ...
    "CONSULTING": "Free get 1 lottery winner each month to have their strategy fixed begins October with rirst draw y sept 30 – shared on live webinar with anonympups attendees only – must be registered with login alias "
  };
  ...
  const messages2: { [key: string]: string | string[] } = {
    ...
    "COURSE": "Paid members will get added into the first cohort of 33 people – module every other week – 33 steps – first class is October launch ",
    "COMMUNITY": [
    ...
    "CRITIQUE": "They would request the experts they want to replace or interview to be PRSPERA Authorized and we will get back to them when we have secured them – we would need a minimum of 100 per legal jurisdiction - city as requested – e.g. 100 people in new york city want a tax lawyer PRSPERA Authorized  ",
    "CRITICAL TOOLS": "List all the tools to be made available – in Oct/Nov - for now here is a list of key problems by dept or function check all the areas in which you have struggles in – PAID _ this could come out of the ROI interview with the concierge  PRSPERA Advisor  ",
    "CURATED": "",
    "CURES (Done–for–You Tools)": "UPh SS, MS, OS",
    "COACHING (Winning skills – course relevant)": "ilve sessions monthly with topics selected month prior – may include featured guest speakers where relevant and available ",
    "CLOUT": [
      "Welcome to the World’s First and Only Proprietary GPT on Maximizing Monetizable Value, Tax Effectively – For All Invested.   ",
      "Use this GPT to help you 24/7 to learn, direct and strategize how to Grow Smarter by maximizing value correctly so that you protect and capitalize on the years of value you built to exit richer  "
    ...
    <section className="bg-white h-auto ">
      ...
      <div className='lg:flex md:flex mt-14 lg:mx-32 md:mx-40 mx-4'>
        ...
        <div className='pl-7 pt-4 lg:pt-0 md:pt-0 space-y-4 text-gray-700 text-lg leading-relaxed font-walbaum'>
          ...
          <p>They fail (on exit) because they didn’t create a business with marketable value that creates the generational wealth they and their family dynasty deserves for the years they sacrificed and invested in building that business.” </p>
          <p>-Harish Chauhan</p>
        </div>
      </div>
      ...
      < div className='h-auto mt-14 lg:mx-32 md:mx-40 mx-4 lg:border-2 md:border-2 border-black lg:flex md:flex ' >
        ...
        < div className='h-auto lg:w-[280px] mb:w-[280px] bg-gray-200 lg:mx-0 md:mx-0' >
          ...
          <p className='px-4 font-sans pt-4'>Wednesday, August 20, 2025 <br />10am est –11am est Success Story​ 11:15am est-12:15pm est Q&A </p>
        ...
        < div className='h-[736px] w-[362px] bg-black' >
          ...
          <h1 className='text-base font-sans text-white px-2 pt-3'>You’ll be entered into a lottery for any remaining 33 live seats. No cost to enter. Attendance is not guaranteed</h1>
          <h1 className='text-base font-sans text-white px-2 pt-4'>If NOT selected in the lottery, you’ll still receive:</h1>
        ...
        < div className='h-[736px] w-[362px] bg-slate-100' >
          ...
          <p className='text-center font-sans font-light pt-2 px-2'>One time purchase. Lifetime Value. ​Discounted 94%+. Limited Time Offer.</p>

          <hr className="border-t-2 border-black mt-6" />

          <h1 className='text-base font-sans text-black px-2 pt-3'>Be one of the first 33 paid PRSPERA Lifetime members, and you are automatically guaranteed a seat.</h1>
      ...
      < div className='h-auto mt-14 lg:mx-32 md:mx-40 mx-4 lg:border-2 md:border-2 border-black lg:flex md:flex ' >
        ...
        < div className='lg:h-[796px] md:h-[796px] h-[300px] w-[362px] bg-black' >
          ...
          <h1 className='text-center text-2xl pt-4 text-white font-sans'>Become our <br /> Guest</h1>

          <hr className="border-t-2 border-gray-400 mt-8" />

          <h1 className='text-base font-sans text-yellow-600 px-2 pt-3'>TL;DR <br /> Sample each of the 12 PRSPERA Services  with a monthly lottery so all our guests can benefit through participation while also experiencing the benefits of membership.</h1>
        ...
        < div className='h-[796px] w-[362px] bg-slate-100' >
          ...
          <h1 className='text-center text-2xl pt-4 text-black font-sans'>Become a PRSPERA <br />Founding Lifetime Member</h1>


          <hr className="border-t-2 border-black mt-8" />

          <h1 className='text-base font-sans text-yellow-600 px-2 pt-3'>TL;DR <br /> Stop losing enterprise value in the chaos. Lock in PRSPERA once. Make it part of your valuation narrative. Create alignment and accountability across the business. Learn more</h1>
          ...
          <div className="space-y-3 text-black text-base font-sans pt-4 px-2">
            ...
            <div className="flex gap-2">
              ...
              <div className='space-y-2' >
                ...
                <p className="text-sm ">
                  ▪ 10 years of platform access, renewable and transferrable — boost your exit valuation by passing it to an acquirer
                </p>

                <p className="text-sm ">
                  ▪ Permanent advantage for your entire org—execs, managers, staff, and advisors collaborate daily on your smarter growth and richer exit
                </p>

                <p className="text-sm ">
                  Grandfathered pricing—lock in access to all future platform features under Lifetime or Subscription plans (excludes DFY & some DWY services)
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm">
                  1.Disengaged teams destroy value. PRSPERA flips that. Every person in your company stays: <br />
                  <span className='font-medium'>▪ Informed (real-time visibility)​ </span> <br /> <span className='font-medium'>▪ Invested (strategic clarity)​</span> <br />
                  <span className='font-medium'>▪ Incentivized (value-creation metrics)​</span>
                </p>

                <p className="text-sm">
                  2.Every day becomes an opportunity to: ​ <br />
                  <span className='font-medium'>▪ Resude Risk​ </span> <br /> <span className='font-medium'>▪ Increase EBITDA​​</span> <br />
                  <span className='font-medium'>▪ Monetize intangibles​​</span>
                </p>

                <p className='text-sm'>Not someday Now Everyone becomes accountable and incentivized to build value smarter.</p>
        ...
        <div className="w-[362px] h-[600px] flex flex-col bg-black text-white lg:p-2 md:p-2 p-4">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar space-y-3 ">
            {Array.isArray(messages1[activeItem]) ? (
              messages1[activeItem].map((msg, index) => (
                <p key={index} className="text-base">{msg}</p>
              ))
            ) : (
              <p className="text-base">{messages1[activeItem] || "Content coming soon..."}</p>
            )}
          </div>

          <button
            onClick={() => navigate("/auth")}
            className="h-[50px] w-[340px] border-2 border-yellow-600 bg-black text-lg font-medium text-yellow-600 mt-4 self-center"
          >
            Register for Free
          </button>
        </div>
        ...
        <div className="w-[362px] h-[600px] flex flex-col bg-white text-black lg:p-2 md:p-2 p-4">
          <div className="flex-1 overflow-y-auto custom-scrollbar space-y-3">
            {Array.isArray(messages2[activeItem]) ? (
              messages2[activeItem].map((msg, index) => (
                <p key={index} className="text-base">{msg}</p>
              ))
            ) : (
              <p className="text-base">{messages2[activeItem] || "Content coming soon..."}</p>
            )}
          </div>
          <button
            onClick={() => navigate("/auth")}

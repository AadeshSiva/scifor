...
import Landingpart from "./LandingMiddle.js";
...
export default function Landing() {
  ...
  const circleinfodata = [
    ...
    { heading: "Monetize the invisible", text: "Turn Your Hidden Assets into Transferable Wealth", Url: "https://drive.google.com/file/d/11btStJ5NAHsFzZUEhUtoEkQpe5rRTSc_/preview" },
    { heading: "Scale without sacrifice", text: "Build a Business That Runs and Grows Without You", Url: "https://drive.google.com/file/d/14wTGE-ONeOVmRftVSr-dO8aJoiBZTR--/preview" },
    { heading: "Perform under due diligence", text: "Stage Your Business Like a Premium Asset, Not a Project", Url: "https://drive.google.com/file/d/1Dz1mnzqrDgsrL5He7whpIziGYmc6CnvA/preview" },
    { heading: "Practice the exit – before it’s real", text: "Rehearse the Deal So You Win Under Pressure", Url: "https://drive.google.com/file/d/1d7ew7mXs3c19i4E3J3BndrzMHvfN_i1u/preview" },
    { heading: "Live a life of Pride not regret", text: "Leave a legacy ​of reverence,​not shame​", Url: "https://drive.google.com/file/d/1x9lQkXldCgzqfWMc91BLVgX0ZFkx4cIq/preview" },
  ];
    ...
    <>
      ...
      <section className="w-full p-4 py-8 bg-black flex flex-col items-center gap-5">
        ...
        <p className="text-center text-white text-sm md:text-base max-w-[90%] md:max-w-[40%] font-light leading-relaxed">
          Since 2003, Jeff successfully operationalized the Unifying Philosophy (UPhTM) <br />
          Strategy System TWICE.<br />
          His 20+ year journey inspired our 6 Step Course for entrepreneurs to Grow Smarter to Exit Richer.
        ...
        <div className="flex justify-center items-center text-white p-8">
          <div className="relative w-[80vw] max-w-[400px] aspect-square bg-white rounded-full flex justify-center items-center">
            ...
            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2" onClick={() => setCircleinfo(0)}>
            ...
            <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2" onClick={() => setCircleinfo(3)}>

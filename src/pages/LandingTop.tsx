...
const StorySection: React.FC = () => {
    ...
    const handleRegisterClick = () => {
        console.log("Register for webinar clicked");
    };
    ...
    return (
        <div className="bg-[#757575] text-white py-16 px-4 md:px-8 lg:px-16">
            <div className="max-w-6xl mx-auto text-center">
                ...
                alt="Video thumbnail of a conference room with a play button"
                className="w-full rounded-lg"
              /> */}
                            <video className="rounded-xl h-[600px] w-[600px]" src='https://drive.google.com/file/d/1YLoXKNla2Yqr79ZqaHQakk6KDi8aGrYo/preview' controls></video>
                        </div>
                    </div>
            ...
            <div className="max-w-6xl mx-auto text-center mt-20">
              ...
              className="w-full rounded-lg"
            /> */}
                        <img src={JetImg} alt="Jeff Cullen and his wife" className="w-full rounded-lg" />
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 space-y-4 text-sm font-light">
                        ...
                        <div className="font-medium text-xl">
                            ...
                            <p className="mt-6">
                                ...
                                <span className="text-black font-semibold"> Prosperity For AllTM.</span>
                            </p>
                            <div className="font-semibold text-black">
                                <p className="mt-6">Prosperity For AllTM.</p>
                                <p>

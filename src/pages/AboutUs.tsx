...
import JetImg from "../../public/assets/AboutUs.jpg";
import React, { useState, useEffect, CSSProperties, MouseEvent } from "react";
import { HiOutlineMail } from "react-icons/hi";

// Using hosted placeholder images
const imgPrsperaLogoTransparent =
  "https://via.placeholder.com/296x47/FFFFFF/000000?text=PRSPERA";
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-black font-linear-grotesk font-normal text-base md:text-lg leading-relaxed">
            <p>
              ...
              <span>
                {" "}
                and inventor of the UPh™️ (Unifying Philosophy), a proven system
                for converting hidden intangible assets into measurable
                enterprise value. Harish is the author of Unconventional
                Business - 3 Startling Truths for Corporate Prosperity.
              </span>
            </p>
            <p>
              With over three decades of experience advising 200+ CEOs, building
              150+ brands, and leading growth consultancies, he has helped
              businesses achieve premium exits and sustainable wealth. After a
              health emergency in 2012 forced him to rebuild from scratch,
              Harish returned with a renewed mission: to ensure leaders scale
              smarter, preserve their legacy, and exit richer.
            </p>
          </div>
        ...
        <div className="flex justify-center lg:justify-end">
          <img
            src={JetImg}
            alt="Jeff Cullen"
            className="w-full h-[734px] rounded-lg object-cover max-w-[630px]"
          />
        </div>
      </div>
    </main>

...
//                       // Video iframe
//                       <iframe
//                         src="https://www.youtube.com/watch?v=TEq8Fnhkza8&feature=youtu.be" //since the one drive link is not working we need to replace it with Gdrive link.
...
//         </h2>
//         <h3 className="text-3xl md:text-4xl lg:text-5xl font-Bold font-walbaum mt-6" >
//           Here’s more proof.
//         </h3> <br />
...
//           {/* Button */}
//           <JoinBtn page="/pricing-page">JOIN PRSPERA</JoinBtn>
...
/* Mobile-friendly tooltip: tap to toggle on mobile, hover on desktop */
const TooltipItem = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="flex items-start relative">
      <button
        ...
        className="group relative w-5 h-5 bg-[#A4A4A4] rounded-full mt-1 mr-4 flex-shrink-0 flex items-center justify-center text-white text-sm font-semibold cursor-pointer font-linear"
      >
        i
        <div
          className={`absolute top-full left-0 mt-2 ml-3 transition-opacity duration-200 pointer-events-none z-10 ${
            open ? "opacity-100" : "opacity-0"
          } group-hover:opacity-100`}
        >
          <div className="relative drop-shadow-lg">
            <div
              className="bg-[#595959] text-white px-4 py-2 rounded-sm font-thin text-sm text-left
                         whitespace-normal sm:whitespace-nowrap break-words
                         w-56 max-w-[92vw] sm:w-auto"
            >
              This synchronizes the business system – people, process, tech.
            </div>
            <div
              className="absolute left-4 -top-[14px] w-4 h-4 bg-[#595959]"
      ...
      <p className="text-base sm:text-lg md:text-xl font-light font-linear leading-relaxed">
        {children}
      </p>
    </div>
  );
      ...
      <div className="bg-gray-100 w-full">
        <div className="w-full px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 py-12 sm:py-16 md:py-20">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-normal font-walbaum  text-gray-800 mb-4 sm:mb-6">
              of Success.
            </h2>
            <p className="text-lg sm:text-xl font-walbaum text-gray-600 mb-8 sm:mb-12">
              Jeff&apos;s success is a template for your success.
            </p>

            {/* Video */}
            <div className="flex items-center justify-center">
              <div className="w-full lg:w-4/5 xl:w-3/4 flex justify-center">
                <div className="relative w-full max-w-3xl rounded-xl overflow-hidden">
                  {/* 16:9 aspect ratio box */}
                  <div className="relative w-full pb-[56.25%] bg-black/10 rounded-xl overflow-hidden">
                    {!showVideo ? (
                      <>
                        <img
                          src="/assets/ProofThumbnail.png"
                        ...
                        <button
                          ...
                          type="button"
                        >
                          <div className="w-14 h-14 sm:w-16 sm:h-16 bg-black/60 rounded-full flex items-center justify-center hover:bg-black/80 transition-all">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
...
/>
      ...
      {/* Second Section - U-Ph Philosophy */}
      <div className="bg-[#7E7E7E] w-full">
        <div className="w-full px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 py-12 sm:py-16 md:py-20 text-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 sm:mb-12">
              {/* Responsive, no fixed width/height */}
              <div className="mx-auto max-w-[961px]">
                <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-walbaum font-thin">
                  Jeff built and sold
                </h3>
                <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-walbaum font-normal mb-2 sm:mb-3">
                  2 valuable companies
                </h3>
                <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-walbaum font-extralight">
                  using a Unifying Philosophy (UPh™)
                </h3>
                <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-walbaum font-normal">
                  twice.
                </h3>
              </div>

              <h4 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-walbaum font-extralight mb-4 sm:mb-8">
                What is a Unifying Philosophy (UPh)?
              </h4>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-linear font-thin leading-relaxed text-left max-w-4xl mx-auto px-2 sm:px-4">
                The UPh is:
              </p>
            </div>
      ...
      {/* Third section - The Unifying Philosophy Works */}
      <div className="text-white bg-[#474646] py-10 sm:py-12 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-walbaum font-thin mb-1 sm:mb-2">
            The Unifying Philosophy Works
          </h2>
          <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-walbaum font-thin mb-4">
            Unlike Anything Else In The World
          </h2>
      ...
      <tr>
        ...
        <td className="border-[2px] border-white px-3 py-2 sm:px-4 sm:py-3">
          Unifying Philosophy (UPh)
            ...
            <p className="text-base sm:text-lg md:text-xl font-linear font-light leading-relaxed ml-4 sm:ml-6 md:ml-14">
              This proves the UPh synchronizes the business system.
            </p>
            ...
            <div className="ml-2 sm:ml-4 md:ml-6 space-y-5 sm:space-y-6">
              <div>
                <p className="text-base sm:text-lg md:text-xl font-linear font-light">

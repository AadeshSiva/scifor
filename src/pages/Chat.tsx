...
const filterAbusiveContent = async (text) => {
  try {
    const response = await fetch(
      `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyAsZ7bQiqUZdrAn9FVW1zUUjx6h1JsPZzg`,
      {
        method: "POST",
        headers: {
...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    const connectWebSocket = () => {
      ...
      try {
        ...
        const wsUrl = `wss://api.prspera.com/ws/chat/general/?token=${token}`;
  ...
  const formatBackendMessage = (backendMsg) => {
    ...
    return {
      ...
      time: new Date(backendMsg.timestamp).toLocaleTimeString([], {
        hour: "2-digit",
        minute: "2-digit",
      }),
      isUser: backendMsg.sender === user?.full_name,
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentPinnedMessage((prev) => (prev + 1) % pinnedMessages.length);
      ...
      {showSidebar && (
        ...
        >
          ...
          <div className="mt-auto">
            ...
            <div
              className="flex items-center gap-3 px-6 py-3.5 pb-8 hover:bg-white cursor-pointer transition-colors"
              onClick={() => {
                setDisplay("setting");
              }}
            >
            ...
            <>
              ...
              <header className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-[rgba(158,158,158,0.3)] bg-white pb-6">
                <div className="flex items-center gap-2 sm:gap-4">
                  ...
                  <div className="w-12 h-12 bg-[#555] rounded-full flex items-center justify-center text-white"></div>
                ...
                <div className="w-full flex items-center justify-center bg-neutral-100 px-2 sm:px-5 py-3 border-b border-[rgba(158,158,158,0.3)]">
                  <div className="flex items-center gap-4">
                    ...
                    <button aria-label="Toggle up" className="p-1 hover:bg-white rounded-full">
                      ...
                      >
                        <path
                          d="M11.9999 10.8286L16.9497 15.7783L18.3639 14.3641L11.9999 8.0001L5.63599 14.3641L7.0502 15.7783L11.9999 10.8286Z"
                          fill="#555555"
                        />
                      </svg>
                    </button>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      aria-label="Close"
                      className="w-6 h-6 flex justify-center items-center bg-white rounded-full border border-[rgba(158,158,158,0.4)] hover:bg-neutral-100"
                    ...
                    >
                      ...
                      >
                        <path
                          d="M10.0101 9.00037L15.5765 14.5668L14.5663 15.5769L8.99996 10.0106L3.4336 15.5769L2.42346 14.5668L7.98981 9.00037L2.42346 3.43408L3.4336 2.42387L8.99996 7.99023L14.5663 2.42387L15.5765 3.43408L10.0101 9.00037Z"
                          fill="#555555"
                        />
                      </svg>
                    </button>
                ...
                <div className="bg-neutral-100 shadow-[0px_2px_6px_rgba(0,0,0,0.1)] flex items-center px-5 py-3 border-b border-[rgba(158,158,158,0.3)]">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M14 11V3h.5C15.33 3 16 2.33 16 1.5S15.33 0 14.5 0h-9C4.67 0 4 .67 4 1.5S4.67 3 5.5 3H6v8c0 2.97-2.16 5-5 5v2h7v7l1 1 1-1v-7h7v-2c-2.84 0-5-2.03-5-5z"
                          fill="#555"
                        />
                      </svg>
                    </button>
                          ...
                          <div className={`flex flex-col ${msg.replyTo ? "mt-2" : "mt-0"}`}>
                            ...
                            <div className="bg-neutral-100 ml-auto border w-auto max-w-[90%] sm:max-w-[70%] text-sm font-normal p-3 sm:p-4 rounded-[20px] border-[rgba(158,158,158,0.5)] border-solid">
                              ...
                              <div className="mt-3 text-xs text-[#9E9E9E]">
                                {msg.pollData.allowMultipleAnswers
                            ...
                            <div className="flex items-center gap-4 text-[10px] text-[#9E9E9E] mt-2 justify-end">
                              {isAdmin && (
                                ...
                                >
                                  ...
                                  >
                                    <path
                                      d="M17 8V4h1.5c.8 0 1.5-.7 1.5-1.5S19.3 1 18.5 1h-13C4.7 1 4 1.7 4 2.5S4.7 4 5.5 4H7v4c0 3-2.2 5-5 5v2h8v7l1 1 1-1v-7h8v-2c-2.8 0-5-2-5-5z"
                                      fill="#9E9E9E"
                                    />
                                  </svg>
                                </button>
                ...
                <div className="bg-white shadow-[0px_-2px_6px_rgba(0,0,0,0.1)] flex w-full items-center justify-between px-6 py-3 border-t border-[rgba(158,158,158,0.3)]">
                  <div className="flex items-center gap-4">
                    <button>
                      ...
                      >
                        <path
                          d="M10 9V5l-7 7 7 7 7v-4.1c5 0 8.5 1.6 11 5.1-1-5-4-10-11-11z"
                          fill="#9E9E9E"
                        />
                      </svg>
                    </button>
              ...
              <form
                ...
                className="bg-neutral-100 flex items-center gap-2 sm:gap-4 p-3 sm:p-4 px-4 sm:px-6 border-t border-[rgba(158,158,158,0.5)] flex-shrink-0"
              >
                {isAdmin ? (
                  <button
                    type="button"
                      ...
                      <header className="bg-gray-50 border-b border-gray-200">
                        <div className="flex items-center justify-between px-6 py-4">
                          ...
                          >
                            ...
                            >
                              <path
                                d="M8.85062 10.3274L15.3447 16.8215L14.1662 18L7.67212 11.506L1.17804 18L-0.000463486 16.8215L6.49362 10.3274L-0.000463486 3.33337L1.17804 2.65479L7.67212 9.14888L14.1662 2.65479L15.3447 3.83337L8.85062 10.3274Z"
                                fill="currentColor"
                              />
                            </svg>
                          </button>
